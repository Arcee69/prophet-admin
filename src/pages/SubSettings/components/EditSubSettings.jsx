...
const EditSubSettings = ({ handleClose, fetchSubSettings, subSettingsData }) => {
  ...
  return (
     <div className='flex flex-col gap-5'>
            ...
            <Formik
                initialValues={{
                    pricingPlanName: subSettingsData?.name || "",
                    planIntended: subSettingsData?.intened_users || "",
                    monthlyAmount: subSettingsData?.monthly_amount || "",
                    yearlyAmount: subSettingsData?.annual_amount || "",
                    description: subSettingsData?.features || ""
                }}
