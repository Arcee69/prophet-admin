...
const Faqs = ({
  ...
  return (
    <div>
        <div className={`${filteredFaq?.length > 0 ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[32px]" :  "flex items-center justify-center"}`}>
            {loading ? 
                <p className=' text-GREY-200 font-jost text-center font-medium'>Loading Faq...</p> :
                ...
                <p className=' text-GREY-200 font-jost text-center font-medium'>No Faq Available</p>
            }
        </div>
