...
const UserDetails = ({ handleClose, userData }) => {
        ...
        <div className='flex gap-5 flex-col'>
            <div className='flex items-center gap-5'>
                <div className='flex flex-col w-[133px] gap-[5px]'>
                    ...
                    <p className='font-jost text-DARK-600 text-sm leading-[21px]'>{userData.id?.slice(0, 8)}</p>
                </div>
                <div className='flex flex-col w-[133px] gap-[5px]'>
                    <p className='font-jost text-base leading-[100%] text-NEUTRAL-500'>Name</p>
                    <p className='font-jost text-DARK-600 text-sm leading-[21px]'>{userData.name}</p>
                </div>
            </div>
            <div className='flex items-center gap-5'>
                <div className='flex flex-col w-[133px] gap-[5px]'>
                    <p className='font-jost text-base leading-[100%] text-NEUTRAL-500'>Email</p>
                    <p className='font-jost text-DARK-600 text-sm leading-[21px]'>{userData.email}</p>
                </div>
                <div className='flex flex-col w-[133px] gap-[5px]'>
                    <p className='font-jost text-base leading-[100%] text-NEUTRAL-500'>Role</p>
                    <p className='font-jost text-DARK-600 text-sm leading-[21px]'>{userData.role}</p>
                </div>
            </div>
            <div className='flex items-center gap-5'>
                <div className='flex flex-col w-[133px] gap-[5px]'>
                    <p className='font-jost text-base leading-[100%] text-NEUTRAL-500'>Date Added</p>
                    <p className='font-jost text-DARK-600 text-sm leading-[21px]'>{new Date(userData.created_at).toLocaleDateString()}</p>
                </div>
            </div>
